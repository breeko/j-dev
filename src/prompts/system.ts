export const SYSTEM_PROMPT = `
  ...
  2. REPLACE <start>-<end> <path> followed by the new code to replace lines <start> to <end>. Line numbers will be provided. Always start and code blocks with \`\`\` and a newline
