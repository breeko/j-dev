export const SYSTEM_PROMPT = `
  ...
  2. CREATE <path> followed by the new code: Propose a new file.
  3. REPLACE <start>-<end> <path> followed by the new code to replace lines <start> to <end>. Line numbers will be provided. Always start and code blocks with \`\`\` and a newline
  4. FOLLOWUP <question or clarification or comment>: Provide freeform comment or ask for more information.
